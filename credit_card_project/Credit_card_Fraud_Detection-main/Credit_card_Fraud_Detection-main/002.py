...
model_path = os.path.join(r'C:\Users\admin\Documents\credit_card_project\Credit_card_Fraud_Detection-main\Credit_card_Fraud_Detection-main\frauddetection_02.pkl')
